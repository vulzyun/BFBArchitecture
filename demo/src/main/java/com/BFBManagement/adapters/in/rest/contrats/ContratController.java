package com.BFBManagement.adapters.in.rest.contrats;

import com.BFBManagement.adapters.in.rest.contrats.dto.ContratDto;
import com.BFBManagement.adapters.in.rest.contrats.dto.CreateContratDto;
import com.BFBManagement.adapters.in.rest.contrats.dto.MarkLateResponse;
import com.BFBManagement.adapters.in.rest.contrats.mappers.ContratMapper;
...
public class ContratController {
    ...
    public ContratController(ContratUseCase contratUseCase, ContratMapper contratMapper) {
    ...
    public ResponseEntity<ContratDto> create(@Valid @RequestBody CreateContratDto dto) {
        Contrat contrat = contratUseCase.create(
            dto.clientId(),
            dto.vehiculeId(),
            dto.dateDebut(),
            dto.dateFin()
    ...
    public ResponseEntity<ContratDto> getById(@PathVariable UUID id) {
        Contrat contrat = contratUseCase.findById(id);
    ...
    public ResponseEntity<List<ContratDto>> search(
        ...
        List<Contrat> contrats = contratUseCase.findByCriteria(clientId, vehiculeId, etat);
    ...
    public ResponseEntity<ContratDto> start(@PathVariable UUID id) {
        Contrat contrat = contratUseCase.start(id);
        return ResponseEntity.ok(contratMapper.toDto(contrat));
    }
    ...
    public ResponseEntity<ContratDto> terminate(@PathVariable UUID id) {
        Contrat contrat = contratUseCase.terminate(id);
        return ResponseEntity.ok(contratMapper.toDto(contrat));
    }
    ...
    public ResponseEntity<ContratDto> cancel(@PathVariable UUID id) {
        Contrat contrat = contratUseCase.cancel(id);
        return ResponseEntity.ok(contratMapper.toDto(contrat));
    }
    ...
    public ResponseEntity<MarkLateResponse> markLate() {
        int count = contratUseCase.markLateIfOverdue();
        return ResponseEntity
