        ...
        return new OpenAPI()
            .info(new Info()
                ...
                .description("""
                    ...
                    L'application suit une architecture **3-couches classique** :
                    - **Interfaces** : Controllers REST et DTOs
                    - **Business** : Services métier et modèles
                    - **Infrastructures** : Persistence et accès externes
