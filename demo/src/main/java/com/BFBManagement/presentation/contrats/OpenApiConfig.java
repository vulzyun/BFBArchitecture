        ...
        return new OpenAPI()
            .info(new Info()
                ...
                .description("""
                    ...
                    L'application suit une architecture **Ports & Adapters** (Hexagonale) :
                    - **Presentation Layer** : Controllers REST et DTOs
                    - **Business Layer** : Services métier et règles de gestion
                    - **Architecture Layer** : Domain models et repositories
